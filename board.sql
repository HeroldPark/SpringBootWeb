...
INSERT INTO `member` (`id`, `name`, `pwd`, `email`) VALUES
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `noticeview` AS SELECT n.*, m.name memberName 
from notice n 
	JOIN member m ON n.writerId = m.id ;
